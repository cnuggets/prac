!function(e){"function"==typeof define&&define.amd?define(["jquery","underscore","bootstrap","common"],e):"object"==typeof exports?e(require("jquery")):e(jQuery)}(function(b,m,e){function d(e){var n=!0;function t(e){var n=e.val(),t=e.attr("pattern");e.attr("required")?(0==n.length?l:o)(e):t&&(n.match(new RegExp(t))?o:l)(e)}function i(e){var n;e.attr("required")&&(0==(n=e.find("option:selected")).length||1==n.length&&0==n.val().length?l:o)(e)}function a(e){e.attr("required")&&(e.is(":checked")?o:l)(e)}function s(e){e.removeClass("is-valid"),e.removeClass("is-invalid")}function o(e){e.removeClass("is-invalid").addClass("is-valid")}function l(e){n=!1,e.removeClass("is-valid").addClass("is-invalid")}return 0<e.length&&e.hasClass("needs-validation")&&(b.each(e.find("input[type='text'],input[type='password']"),function(e,n){s(b(n)),t(b(n)),b(n).on("change",function(){t(b(this))})}),b.each(e.find("select"),function(e,n){s(b(n)),i(b(n)),b(n).on("change",function(){i(b(this))})}),b.each(e.find("input[type='checkbox']"),function(e,n){s(b(n)),a(b(n)),b(n).on("change",function(){a(b(this))})})),n}function i(e,s,o,l){var c=e;l=l||{};l=b.extend(!0,{},{autoTrigger:!1,close:!0,footer:!0,confirm:{class:"primary",label:"Confirm",waiting:"Waiting",onConfirm:null},cancel:{class:"secondary",label:"Cancel",onCancel:null,disabled:!1}},l);var n;function t(){var e,n=b(m.template(`
        ...
        `)({selecteds:i,options:o,opt:t})),d=n.find(".selected"),r=n.find(".select");function f(){r.find("ul.options li").on("click",function(e){e.stopPropagation();var n,t=b(this).find("span.checked i"),i=b(this).find("span:last-child"),e=i.attr("value");t.hasClass("bi-check-lg")?p(d.find("span label[value='"+e+"']").closest("span")):s?(n=`
                        ...
                        `)({value:e,text:i.text()}))).find("i").on("click",function(e){e.stopPropagation(),p(b(this).closest("span"))}),t.addClass("bi-check-lg"),d.append(i),a.find("option[value='"+e+"']").prop("selected",!0).change())})}function p(e){var n=e.find("label").attr("value");r.find("li span[value='"+n+"']").siblings("span").find("i").removeClass("bi-check-lg"),e.remove(),a.find("option[value='"+n+"']").prop("selected",!1).change()}function u(s,o){var e=r.find("ul.options li span:last-child");b.each(e,function(e,n){var t=b(n).text(),i=new RegExp(s,"i"),a=t.match(i);a?(a=t.substring(a.index,a.index+s.length),b(n).html(t.replace(i,"<b>"+a+"</b>")),b(n).closest("li").show()):o&&b(n).closest("li").hide()})}b.each(d.find("span i"),function(e,n){b(n).on("click",function(e){e.stopPropagation(),p(b(this).closest("span"))})}),d.on("click",function(e){e.stopPropagation(),r.is(":hidden")?r.show():r.hide()}),r.on("click",function(e){e.stopPropagation()}),b("body").on("click",function(){r.hide()}),f(),t.search&&(e=n.find(".search input"),l=r.find(".search .spinner-border"),t.search.async?e.on("keyup",function(e){var n=b(this).val();clearTimeout(c),c=setTimeout(function(){l.show(),t.search.async(n,function(e){r.find("ul").html(m.template(`
                                <%_.each(options, function(option) {%>
                                    <li>
                                ...
                                <% }); %>
                            `)({options:e})),u(n),l.hide(),f()})},600)}):e.on("keyup",function(e){u(b(this).val(),!0)})),a.after(n),a.hide()},b.fn.stepper=function(n){var t=b(this);n=n||{};n=b.extend(!0,{},{class:"primary",default:0,step:1,decimal:0},n);var e=b(m.template(`
