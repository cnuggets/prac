!function(e){"function"==typeof define&&define.amd?define(["jquery","underscore","bootstrap","common"],e):"object"==typeof exports?e(require("jquery")):e(jQuery)}(function(b,m,e){function r(e){var n=!0;function t(e){var n=e.val(),t=e.attr("pattern");e.attr("required")?(0==n.length?l:o)(e):t&&(n.match(new RegExp(t))?o:l)(e)}function i(e){var n;e.attr("required")&&(0==(n=e.find("option:selected")).length||1==n.length&&0==n.val().length?l:o)(e)}function a(e){e.attr("required")&&(e.is(":checked")?o:l)(e)}function s(e){e.removeClass("is-valid"),e.removeClass("is-invalid")}function o(e){e.removeClass("is-invalid").addClass("is-valid")}function l(e){n=!1,e.removeClass("is-valid").addClass("is-invalid")}return 0<e.length&&e.hasClass("needs-validation")&&(b.each(e.find("input[type='text'],input[type='password']"),function(e,n){s(b(n)),t(b(n)),b(n).on("change",function(){t(b(this))})}),b.each(e.find("select"),function(e,n){s(b(n)),i(b(n)),b(n).on("change",function(){i(b(this))})}),b.each(e.find("input[type='checkbox']"),function(e,n){s(b(n)),a(b(n)),b(n).on("change",function(){a(b(this))})})),n}function i(e,s,o,l){var c=e;l=l||{};l=b.extend(!0,{},{autoTrigger:!1,close:!0,footer:!0,confirm:{class:"primary",label:"Confirm",waiting:"Waiting",onConfirm:null},cancel:{class:"secondary",label:"Cancel",onCancel:null,disabled:!1}},l);var n;function t(){var e,n=b(m.template(`
        ...
        `)({selecteds:i,options:o,opt:t})),r=n.find(".selected"),d=n.find(".select");function f(){d.find("ul.options li").on("click",function(e){e.stopPropagation();var n,t=b(this).find("span.checked i"),i=b(this).find("span:last-child"),e=i.attr("value");t.hasClass("bi-check-lg")?u(r.find("span label[value='"+e+"']").closest("span")):s?(n=`
                            <label class="single" value="<%=value%>"><%=text%></label>
                        `,d.find("span.checked i").removeClass("bi-check-lg"),t.addClass("bi-check-lg"),r.html(m.template(n)({value:e,text:i.text()})),a.find("option[value='"+e+"']").prop("selected",!0).change(),d.hide()):((i=b(m.template(n=`
                            <span class="item">
                                <label value="<%=value%>"><%=text%></label>
                                <i class="bi bi-x-lg"></i>
                            </span>
                        `)({value:e,text:i.text()}))).find("i").on("click",function(e){e.stopPropagation(),u(b(this).closest("span"))}),t.addClass("bi-check-lg"),r.append(i),a.find("option[value='"+e+"']").prop("selected",!0).change())})}function u(e){var n=e.find("label").attr("value");d.find("li span[value='"+n+"']").siblings("span").find("i").removeClass("bi-check-lg"),e.remove(),a.find("option[value='"+n+"']").prop("selected",!1).change()}function p(s,o){var e=d.find("ul.options li span:last-child");b.each(e,function(e,n){var t=b(n).text(),i=new RegExp(s,"i"),a=t.match(i);a?(a=t.substring(a.index,a.index+s.length),b(n).html(t.replace(i,"<b>"+a+"</b>")),b(n).closest("li").show()):o&&b(n).closest("li").hide()})}b.each(r.find("span i"),function(e,n){b(n).on("click",function(e){e.stopPropagation(),u(b(this).closest("span"))})}),r.on("click",function(e){e.stopPropagation(),d.is(":hidden")?d.show():d.hide()}),d.on("click",function(e){e.stopPropagation()}),b("body").on("click",function(){d.hide()}),f(),t.search&&(e=n.find(".search input"),l=d.find(".search .spinner-border"),t.search.async?e.on("keyup",function(e){var n=b(this).val();clearTimeout(c),c=setTimeout(function(){l.show(),t.search.async(n,function(e){d.find("ul").html(m.template(`
                                <%_.each(options, function(option) {%>
                                    <li>
