!function(e){"function"==typeof define&&define.amd?define(["jquery","underscore","bootstrap","async"],e):"object"==typeof exports?e(require("jquery")):e(jQuery)}(function(g,w,e,y){g.fn.uploader=function(e){var i=g(this),a={"application/vnd.ms-excel":"excel","application/vnd.openxmlformats-officedocument.spreadsheetml.sheet":"excel","application/msword":"word","application/vnd.openxmlformats-officedocument.wordprocessingml.document":"word","application/vnd.ms-powerpoint":"ppt","application/vnd.openxmlformats-officedocument.presentationml.presentation":"ppt","application/pdf":"pdf","image/*":"image","video/*":"video","audio/*":"audio","text/html":"html","text/xml":"xml","text/plain":"txt"},h={excel:"bi-file-earmark-excel",word:"bi-file-earmark-word",ppt:"bi-file-earmark-ppt",pdf:"bi-file-earmark-pdf",video:"bi-camera-video",audio:"bi-optical-audio",html:"bi-file-earmark-code",xml:"bi-file-earmark-code",txt:"bi-file-earmark-text",file:"bi-file-earmark",directory:"bi-folder",image:"bi-image"},o={".jpg":"image",".jpeg":"image",".png":"image",".svg":"image",".gif":"image",".xls":"excel",".xlsx":"excel",".doc":"word",".docx":"word",".ppt":"ppt",".pptx":"ppt",".pdf":"pdf",".mp4":"video",".webm":"video",".mp3":"audio",".wma":"audio",".html":"html",".xml":"xml",".txt":"txt"};function b(e){var i=e.type,t=a[i];return t||(e=i.split("/")[0]+"/*",t=(t=a[e])||"file"),{name:t,originalType:i}}return((e=e||{}).dragdrop?function(l,s){var e={url:"/upload",fieldName:"files",validation:{size:function(e){return!0}},limit:0,allowDownload:!1,title:"Drag and Drop files to upload",browse:{label:"Browse files"},confirm:{title:"File already exists, do you want to replace the existing files?",label:{cancel:"Cancel",confirm:"Replace files"}},beforeUpload:function(e){},onSuccess:function(e,i,t){return e},onError:function(e,i,t){return{code:e.status,msg:e.responseText}},onDelete:function(e,i,t){console.log("delete file",e,"path is",i,"type is",t)}};s=g.extend(!0,{},e,s),l.hasClass("dd-uploader")||l.addClass("dd-uploader");var o=`
