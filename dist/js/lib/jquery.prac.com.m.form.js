!function(e){"function"==typeof define&&define.amd?define(["jquery","underscore","bootstrap","moment","async","common"],e):"object"==typeof exports?e(require("jquery")):e(jQuery)}(function(b,x,e,y,u){b.fn.picker=function(a,o){var e=b(this);o=o||{};if(1==(o=b.extend(!0,{},{columns:1,height:"260px",title:"Please select",toolbar:!0,cancel:{label:"Cancel",class:"secondary"},confirm:{label:"Confirm",class:"primary"}},o)).columns)return new c(e,a,o);var s=b(x.template(`
        ...
        `)({currentMonth:y(f).format(c.month.format),days:t,cfg:c})),p=a.find(".body"),o=a.find(".current-month"),t=a.find("button[confirm]"),s=0;s<n;s++)!function(e,t,n){for(var i=new Date(e,t,1),a=new Date(e,t+1,0),o=i.getDay()-m,s=b(x.template(`
                <ul class="month">
        ...
        `;function i(){var n,a=b(x.template(e)({width:s.width,accept:s.accept,icon:s.icon}));function o(e){n.after(e),n.remove(),(s.limit<=0||l.find(".file[count]").length<s.limit)&&i(),e.find(".remove").on("click",function(e){e.stopPropagation(),p(b(this))}),s.onComplete&&s.onComplete(e.index()),t()}l.append(a),a.find("input[type='file']").on("change",function(e){var i,t=e.originalEvent.target.files;0<t.length&&((t=function(e,t){if(s.validation.size(e.size,t)){e=function(e){var t=e.type,n=r[t];n||(e=t.split("/")[0]+"/*",n=(n=r[e])||"file");return{name:n,originalType:t}}(e);if(s.validation.type(e,t))return e}}(e=t[0],a.index()))?(e=e,i=t,(t=new FormData).append(s.fieldName,e),b.ajax({url:s.url,type:"POST",data:t,contentType:!1,processData:!1,xhr:function(){n=b(x.template(d)({width:s.width,icon:s.icon})),a.after(n),a.remove(),"text"==s.progress&&n.find("span").text(s.text.uploading);var e=new window.XMLHttpRequest;return e.upload.addEventListener("progress",function(e){var t;e.lengthComputable&&("percent"==s.progress&&(t=(e.loaded/e.total*100).toFixed(0)+"%",n.find("span").text(t)),s.onProgress&&s.onProgress(e.loaded,e.total))},!1),e},success:function(e,t,n){t=s.onSuccess(e,t,n),n="image"==i.name?b(x.template(u)({width:s.width,path:t.path})):b(x.template(m)({width:s.width,icon:c[i.name],name:t.name}));n.data("file",t),o(n),"image"==i.name&&n.find("div.uploaded").css("height",n.width())},error:function(e,t,n){s.onError(e,t,n),o(b(x.template(f)({error:s.text.failed,icon:s.icon})))}})):b(this).val(null))})}function t(){var e=l.find(".uploaded img");e.off("click"),e.on("click",function(){var n=[];b.each(e,function(e,t){b(t).attr("index",e),n.push({path:b(t).attr("src")})}),b.imagePreview(n).select(parseInt(b(this).attr("index")))})}function p(e){var t=e.closest(".file"),n=t.data("file"),e=t.index();t.remove(),0==l.find(".file[blank]").length&&i(),s.onRemove&&s.onRemove(n,e)}return s.data&&0<s.data.length?(s.data.forEach(function(e){var t,n=e.substring(e.lastIndexOf(".")),i=o[n],a=e.substring(e.lastIndexOf("/")+1);"image"==i?t=b(x.template(u)({width:s.width,path:e})):(n=c[i=i||"file"],a=e.substring(e.lastIndexOf("/")+1),(t=b(x.template(m)({width:s.width,icon:n,name:a}))).on("click",function(){window.location.href=e})),t.data("file",{name:a,path:e}),t.find(".remove").on("click",function(e){e.stopPropagation(),p(b(this))}),l.append(t),"image"==i&&t.find("div.uploaded").css("height",t.width())}),t(),(s.limit<=0||s.data.length<s.limit)&&i()):i(),{files:function(){var n=[];return b.each(l.find(".file"),function(e,t){t=b(t).data("file");t&&n.push(t)}),n},reset:function(){l.find(".file").remove(),i()}}},b.fn.slider=function(o){o=o||{};var i,a,s=(o=b.extend(!0,{},{height:3,classes:[],min:0,max:100,default:0,step:1,onChange:function(e){}},o)).default,e=b(this),t=e.attr("disabled"),l=b(x.template(`
            <div class="p-slider">
        ...
        `)(o)),r=l.find(".progress-bar"),c=l.find(".btn");function n(){i=function(e){e=e.get(0);var t={};for(t.left=e.offsetLeft,t.top=e.offsetTop;e.offsetParent&&(t.left=t.left+e.offsetParent.offsetLeft,t.top=t.top+e.offsetParent.offsetTop,e!=b("body").get(0));)e=e.offsetParent;return t}(l).left,a=i+l.width()}function d(e){s!=e&&(s=e,o.onChange(s));var t,n,i=(t=e,n=c.outerWidth()/2,n=(o.max-o.min)/l.width()*n,a(t-n)),e=a(e);function a(e){return(e-o.min)/(o.max-o.min)*100}c.css("left",i+"%"),r.css("width",e+"%")}function f(){t=!0,e.attr("disabled",!0),e.find(".progress-bar").css("opacity",.6)}return o.btn&&(r.parent().after(o.btn),c.remove(),(c=o.btn).css("position","relative").css("cursor","pointer")),e.append(l),t&&f(),c.css("top",-(c.outerHeight()/2+o.height/2+1)+"px"),n(),d(o.default),c.bindDragMove(function(e,t){e.preventDefault()},function(e,t,n){!function(e){a<(e=e<i?i:e)&&(e=a);var t=o.min+Math.round((o.max-o.min)/(a-i)*(e-i));if(1<o.step)for(var n=o.min;n<o.max&&t!=n;n+=o.step)if(n+o.step<=o.max&&n<t&&t<n+o.step){t=t-n>n+o.step-t?n+o.step:n;break}d(t)}(t.x)},function(e,t,n){}),e.on("touchstart",function(e){e.preventDefault()}),b(window).on("resize",function(){n(),d(s)}),b(window).on("p-resize",function(){n(),d(s)}),{setValue:function(e){d(e)},getValue:function(){return s},disable:f,enable:function(){t=!1,e.removeAttr("disabled"),e.find(".progress-bar").css("opacity","")}}},b.fn.stepper=function(t){var n=b(this);t=t||{};t=b.extend(!0,{},{class:"primary",default:0,step:1,decimal:0},t);var e=b(x.template(`
