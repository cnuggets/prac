!function(e){"function"==typeof define&&define.amd?define(["jquery","underscore","bootstrap","moment","async","common"],e):"object"==typeof exports?e(require("jquery")):e(jQuery)}(function(b,x,e,y,u){b.fn.picker=function(a,l){var e=b(this);l=l||{};if(1==(l=b.extend(!0,{},{columns:1,height:"260px",title:"Please select",toolbar:!0,cancel:{label:"Cancel",class:"secondary"},confirm:{label:"Confirm",class:"primary"}},l)).columns)return new c(e,a,l);var o=b(x.template(`
            ...
            `)({cfg:l}));e.append(o);var s=[];function r(e){var t,i=[];for(t in e)i.push({value:t,text:e[t]});return i}l.cascade?a.forEach(function(e,t){var i=b('<div class="column"></div>');o.find(".columns").append(i);var n=b.extend(!0,{},l,{toolbar:!1,onChange:function(e){t+1<a.length&&s[t+1].setData(r(a[t+1][e]))}});0==t?s.push(new c(i,r(e),n)):s.push(new c(i,r(e[s[t-1].value()]),n))}):a.forEach(function(e,t){var i=b('<div class="column"></div>');o.find(".columns").append(i);t=b.extend(!0,{},l,{column:t,toolbar:!1});s.push(new c(i,e,t))});e=o.find(".toolbar");return e.find("[cancel]").on("click",function(){l.cancel.onCancel&&l.cancel.onCancel()}),e.find("[confirm]").on("click",function(){var i;l.confirm.onConfirm&&(i=[],s.forEach(function(e,t){i[t]=e.value()}),l.confirm.onConfirm(i))}),{select:function(){for(var e=0;e<arguments.length;e++)s[e].select(arguments[e])},pickers:function(){return s}};function c(e,t,i){var o;function n(e){if(o=[],b.isArray(e))e.forEach(function(e){"string"==typeof e||"number"==typeof e?o.push({value:e,text:e}):o.push(e)});else for(var t in e)o.push({value:t,text:e[t]})}n(t);var a=b(x.template(`
                <div class="p-picker">
                    <% if (cfg.toolbar) { %>
                        <div class="toolbar">
        ...
        `)({currentMonth:y(d).format(c.month.format),days:t,cfg:c})),p=a.find(".body"),l=a.find(".current-month"),t=a.find("button[confirm]"),o=0;o<i;o++)!function(e,t,i){for(var n=new Date(e,t,1),a=new Date(e,t+1,0),l=n.getDay()-m,o=b(x.template(`
                <ul class="month">
        ...
        `;function n(){var i,a=b(x.template(e)({width:o.width,accept:o.accept,icon:o.icon}));function l(e){i.after(e),i.remove(),(o.limit<=0||s.find(".file[count]").length<o.limit)&&n(),e.find(".remove").on("click",function(e){e.stopPropagation(),p(b(this))}),o.onComplete&&o.onComplete(e.index()),t()}s.append(a),a.find("input[type='file']").on("change",function(e){var n,t=e.originalEvent.target.files;0<t.length&&(t=function(e,t){if(o.validation.size(e.size,t)){e=function(e){var t=e.type,i=r[t];i||(e=t.split("/")[0]+"/*",i=(i=r[e])||"file");return{name:i,originalType:t}}(e);if(o.validation.type(e,t))return e}}(e=t[0],a.index()),e=function(e){if(o.beforeUpload)return o.beforeUpload(e);return e}(e),t?(e=e,n=t,(t=new FormData).append(o.fieldName,e),b.ajax({url:o.url,type:"POST",data:t,contentType:!1,processData:!1,xhr:function(){i=b(x.template(f)({width:o.width,icon:o.icon})),a.after(i),a.remove(),"text"==o.progress&&i.find("span").text(o.text.uploading);var e=new window.XMLHttpRequest;return e.upload.addEventListener("progress",function(e){var t;e.lengthComputable&&("percent"==o.progress&&(t=(e.loaded/e.total*100).toFixed(0)+"%",i.find("span").text(t)),o.onProgress&&o.onProgress(e.loaded,e.total))},!1),e},success:function(e,t,i){t=o.onSuccess(e,t,i),i="image"==n.name?b(x.template(u)({width:o.width,path:t.path,preview:o.preview})):b(x.template(m)({width:o.width,icon:c[n.name],name:t.name,preview:o.preview}));i.data("file",t),l(i),"image"==n.name&&i.find("div.uploaded").css("height",i.width())},error:function(e,t,i){o.onError(e,t,i),l(b(x.template(d)({error:o.text.failed,icon:o.icon})))}})):b(this).val(null))})}function t(){var e=s.find(".uploaded img");e.off("click"),e.on("click",function(){var i=[];b.each(e,function(e,t){b(t).attr("index",e),i.push({path:b(t).attr("src")})}),b.imagePreview(i).select(parseInt(b(this).attr("index")))})}function p(e){var t=e.closest(".file"),i=t.data("file"),e=t.index();t.remove(),0==s.find(".file[blank]").length&&n(),o.onRemove&&o.onRemove(i,e)}return o.data&&0<o.data.length?(o.data.forEach(function(e){var t,i,n,a;0==e.indexOf("data:image")?(n="",t="image"):(i=e.substring(e.lastIndexOf(".")),t=l[i],n=e.substring(e.lastIndexOf("/")+1)),"image"==t?a=b(x.template(u)({width:o.width,path:e,preview:o.preview})):(i=c[t=t||"file"],n=e.substring(e.lastIndexOf("/")+1),(a=b(x.template(m)({width:o.width,icon:i,name:n,preview:o.preview}))).on("click",function(){window.location.href=e})),a.data("file",{name:n,path:e}),a.find(".remove").on("click",function(e){e.stopPropagation(),p(b(this))}),s.append(a),"image"==t&&a.find("div.uploaded").css("height",a.width())}),t(),o.preview||(o.limit<=0||o.data.length<o.limit)&&n()):o.preview||n(),{files:function(){var i=[];return b.each(s.find(".file"),function(e,t){t=b(t).data("file");t&&i.push(t)}),i},reset:function(){s.find(".file").remove(),n()}}},b.fn.slider=function(l){l=l||{};var n,a,o=(l=b.extend(!0,{},{height:3,classes:[],min:0,max:100,default:0,step:1,onChange:function(e){}},l)).default,e=b(this),t=e.attr("disabled"),s=b(x.template(`
            <div class="p-slider">
