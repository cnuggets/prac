!function(e){"function"==typeof define&&define.amd?define(["jquery","underscore","bootstrap","moment","async","common"],e):"object"==typeof exports?e(require("jquery")):e(jQuery)}(function(b,x,e,y,u){b.fn.picker=function(a,l){var e=b(this);l=l||{};if(1==(l=b.extend(!0,{},{columns:1,height:"260px",title:"Please select",toolbar:!0,cancel:{label:"Cancel",class:"secondary"},confirm:{label:"Confirm",class:"primary"}},l)).columns)return new c(e,a,l);var o=b(x.template(`
        ...
        `;function p(){var a,l=b(x.template(e)({width:s.width,accept:s.accept,icon:s.icon}));function o(e){a.after(e),a.remove(),(s.limit<=0||r.find(".file[count]").length<s.limit)&&p(),e.find(".remove").on("click",function(e){e.stopPropagation(),v(b(this))}),s.onComplete&&s.onComplete(e.index()),t()}r.append(l),l.find("input[type='file']").on("change",function(e){var i,e=e.originalEvent.target.files;0<e.length&&(e=e[0],(i=function(e,t){if(s.validation.size(e.size,t)){e=function(e){var t=e.type,i=n[t];i||(e=t.split("/")[0]+"/*",i=(i=n[e])||"file");return{name:i,originalType:t}}(e);if(s.validation.type(e,t))return e}}(e,l.index()))?function(e,t){if(s.beforeUpload)return s.beforeUpload(e,t);t(e)}(e,function(e){var t,n;t=e,n=i,(e=new FormData).append(s.fieldName,t),b.ajax({url:s.url,type:"POST",data:e,contentType:!1,processData:!1,xhr:function(){a=b(x.template(f)({width:s.width,icon:s.icon})),l.after(a),l.remove(),"text"==s.progress&&a.find("span").text(s.text.uploading);var e=new window.XMLHttpRequest;return e.upload.addEventListener("progress",function(e){var t;e.lengthComputable&&("percent"==s.progress&&(t=(e.loaded/e.total*100).toFixed(0)+"%",a.find("span").text(t)),s.onProgress&&s.onProgress(e.loaded,e.total))},!1),e},success:function(e,t,i){t=s.onSuccess(e,t,i),i="image"==n.name?b(x.template(u)({width:s.width,path:t.path,preview:s.preview})):b(x.template(m)({width:s.width,icon:c[n.name],name:t.name,preview:s.preview}));i.data("file",t),o(i),"image"==n.name&&i.find("div.uploaded").css("height",i.width())},error:function(e,t,i){s.onError(e,t,i),o(b(x.template(d)({error:s.text.failed,icon:s.icon})))}})}):b(this).val(null))})}function t(){var e=r.find(".uploaded img");e.off("click"),e.on("click",function(){var i=[];b.each(e,function(e,t){b(t).attr("index",e),i.push({path:b(t).attr("src")})}),b.imagePreview(i).select(parseInt(b(this).attr("index")))})}function v(e){var t=e.closest(".file"),i=t.data("file"),e=t.index();t.remove(),0==r.find(".file[blank]").length&&p(),s.onRemove&&s.onRemove(i,e)}return s.data&&0<s.data.length?(s.data.forEach(function(e){var t,i,n,a;0==e.indexOf("data:image")?(n="",t="image"):(i=e.substring(e.lastIndexOf(".")),t=l[i],n=e.substring(e.lastIndexOf("/")+1)),"image"==t?a=b(x.template(u)({width:s.width,path:e,preview:s.preview})):(i=c[t=t||"file"],n=e.substring(e.lastIndexOf("/")+1),(a=b(x.template(m)({width:s.width,icon:i,name:n,preview:s.preview}))).on("click",function(){window.location.href=e})),a.data("file",{name:n,path:e}),a.find(".remove").on("click",function(e){e.stopPropagation(),v(b(this))}),r.append(a),"image"==t&&a.find("div.uploaded").css("height",a.width())}),t(),s.preview||(s.limit<=0||s.data.length<s.limit)&&p()):s.preview||p(),{files:function(){var i=[];return b.each(r.find(".file"),function(e,t){t=b(t).data("file");t&&i.push(t)}),i},reset:function(){r.find(".file").remove(),p()}}},b.fn.slider=function(l){l=l||{};var n,a,o=(l=b.extend(!0,{},{height:3,classes:[],min:0,max:100,default:0,step:1,onChange:function(e){}},l)).default,e=b(this),t=e.attr("disabled"),s=b(x.template(`
            <div class="p-slider">
